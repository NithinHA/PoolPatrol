...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMCinemachineZoom : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (_virtualCamera.Lens.FieldOfView != _targetFieldOfView)
            {
                _delta += GetDeltaTime() / _transitionDuration;
                _virtualCamera.Lens.FieldOfView = Mathf.LerpUnclamped(_startFieldOfView, _targetFieldOfView, ZoomCurve.Evaluate(_delta));
            }
            else
            {
