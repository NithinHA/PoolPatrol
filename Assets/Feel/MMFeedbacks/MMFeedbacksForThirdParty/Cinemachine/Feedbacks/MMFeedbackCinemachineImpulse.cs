...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMFeedbackCinemachineImpulse : MMFeedback
    {
        ...
        /// the CinemachineImpulseSource to use to broadcast the impulse
        [Tooltip("the CinemachineImpulseSource to use to broadcast the impulse")]
        ...
        public override float FeedbackDuration { get { return ImpulseSource != null ? ImpulseSource.ImpulseDefinition.TimeEnvelope.SustainTime : 0f; } }

        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            if (Active && ImpulseSource != null)
            {
                float intensityMultiplier = Timing.ConstantIntensity ? 1f : feedbacksIntensity;
                ImpulseSource.GenerateImpulse(Velocity * intensityMultiplier);
            }
        }
    }
}
